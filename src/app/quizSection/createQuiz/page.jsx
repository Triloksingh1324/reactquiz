...
const CreateQuiz = () => {
  ...
  return (
   ...
   <>
<Navbar />
<div className="md:min-h-screen min-h-[60vh] bg-gradient-to-r from-violet-200 to-pink-200 flex flex-col items-center justify-center ">
  <div className="w-full max-w-lg ">
    <form onSubmit={handleSubmit} className="space-y-4">
      {step === 0 && (
        <>
          <div className="flex flex-col items-center justify-center">
            <h2 className="text-2xl font-bold mb-4 mt-[2-rem]">
              Title Of Quiz
            </h2>
            <div className="w-full max-w-sm">
              <input
                ...
                className="max-w-full ml-10 md:ml-0 md:w-full p-4 border-gray-800 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400 transition duration-300 ease-in-out transform hover:scale-105"
          ...
          <div className="w-full max-w-sm flex  items-center">
            <label className="flex items-center  text-lg font-medium text-gray-700">
              <span className="ml-10 md:ml-16 mr-4">Include Score</span>
              <div className="relative">
                ...
                />
                <div
                  className={`w-10 h-4 ml-16 md:ml-[218px] bg-gray-300 rounded-full shadow-inner ${
                    gradingEnabled ? "bg-indigo-600" : "bg-gray-300"
                  }`}
                ></div>
                <div
                  className={`dot ml-16 md:ml-[218px] absolute w-6 h-6 bg-white rounded-full shadow -left-1 -top-1 transition ${
          ...
          <div className="w-full max-w-lg space-y-4">
            <label className="flex items-center text-lg font-medium text-gray-700">
              <span className="mr-16 ml-10 md:ml-16">
              ...
              <div className="relative">
                ...
                />
                <div
                  className={`w-10 h-4 mr-20 bg-gray-300 rounded-full shadow-inner ${
      ...
      {step === 1 && (
        <div className="space-y-4  ml-4 mt-[rem] mb-4 mr-4">
          <h3 className="text-xl ml-4 font-bold text-gray-700">
            How do you want to create the questions?
          </h3>
          <div className="flex space-x-4">
            <div
              className={`max-w-sm ml-4 p-6 rounded-xl shadow-lg text-white cursor-pointer ${
            ...
            <div
              className={`max-w-sm p-4  md:ml-4  rounded-xl shadow-lg text-white cursor-pointer ${
            ...
            >
              <h4 className="text-xl mr-2 font-bold mb-2">Using AI</h4>
              <p className="text-gray-300">
                Create questions using concept name.
              </p>
            </div>
          </div>
        </div>
      ...
      {step === 2 && questionCreationMethod === "manual" && (
        <div className="space-y-4 mt-2 mb-[-2rem]">
          <h3 className="text-xl font-bold text-gray-700 ml-4">
            Select checking type:
          </h3>
          <div className="flex flex-wrap md:flex-nowrap  space-x-4">
            <div
              className={`max-w-[20rem] py-4 px-4 md:p-8 mx-4 mt-2 md:mx-0 rounded-xl shadow-lg transform transition duration-500 text-white cursor-pointer ${
            ...
            <div
              className={`max-w-[20rem] py-4 px-4 md:p-8 mt-2 mx-4 md:mx-0 rounded-xl shadow-lg transform transition duration-500 text-white cursor-pointer ${
                checkingType === "manual"
                  ? "bg-black border-4 border-blue-500"
                  : "bg-black opacity-50"
              }`}
      ...
      {step === 2 && questionCreationMethod === "ai" && (
        <div className="space-y-4 mt-[rem]">
